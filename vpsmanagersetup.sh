...
if [ -d "/etc/squid3/" ]
then
	wget https://raw.githubusercontent.com/fabiokim/phvpsmanager/master/vpsmanager/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://raw.githubusercontent.com/fabiokim/phvpsmanager/master/vpsmanager/squid2.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid3/squid.conf
	wget https://raw.githubusercontent.com/fabiokim/phvpsmanager/master/vpsmanager/payload.txt -O /etc/squid3/payload.txt
...
then
	wget https://raw.githubusercontent.com/fabiokim/phvpsmanager/master/vpsmanager/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget https://raw.githubusercontent.com/fabiokim/phvpsmanager/master/vpsmanager/squid.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid/squid.conf
	wget https://raw.githubusercontent.com/fabiokim/phvpsmanager/master/vpsmanager/payload.txt -O /etc/squid/payload.txt
...
tput setaf 7 ; tput setab 4 ; tput bold ; echo "Para ver os comandos disponíveis use o comando: adm" ; tput sgr0
echo ""
if [[ "$optiondb" = '2' ]]; then
	awk -F : '$3 >= 500 { print $1 " 1" }' /etc/passwd | grep -v '^nobody' > /root/usuarios.db
fi
